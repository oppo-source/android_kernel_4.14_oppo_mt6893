...
void Eeprom_DistortionParamsRead(enum IMGSENSOR_SENSOR_IDX sensor_idx, kal_uint16 slaveAddr)
{
    ...
    kal_uint16 i = 0;
    struct CAMERA_DEVICE_INFO *pCamDeviceObj = &gImgEepromInfo_21015;
            ...
            kal_uint32 sensorID)
{
    ...
    if (is_project(20817) || is_project(20827)
        ...
        pCamDeviceObj = &gImgEepromInfo_21015;
    }
...
enum IMGSENSOR_RETURN Eeprom_CallWriteService(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereoData)
{
    ...
    }else if((is_project(21015) || is_project(21217)) && uSensorId == (IMX766_SENSOR_ID_21015-SENSOR_ID_OFFSET_21015)){
