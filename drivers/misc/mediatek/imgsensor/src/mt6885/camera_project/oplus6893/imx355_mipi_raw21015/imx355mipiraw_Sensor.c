...
static void read_module_data(void)
{
    ...
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][0] = Eeprom_1ByteDataRead(0x00, IMX355_EEPROM_SLAVE_ADDRESS);
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][1] = Eeprom_1ByteDataRead(0x01, IMX355_EEPROM_SLAVE_ADDRESS);
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][48] = 0xFF;
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][49] = 0xFF;
    imgsensor_info.module_id = Eeprom_1ByteDataRead(0x00, IMX355_EEPROM_SLAVE_ADDRESS);
    Oplusimgsensor_Registdeviceinfo(gImgEepromInfo_21015.pCamModuleInfo[IMGSENSOR_SENSOR_IDX_MAIN2].name,
                                    gImgEepromInfo_21015.pCamModuleInfo[IMGSENSOR_SENSOR_IDX_MAIN2].version,
                                    imgsensor_info.module_id);
    /*Read SensorId LensId and VCMId: 2~7*/
    for(i = 2; i < 8; i++) {
       gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][i] = Eeprom_1ByteDataRead(0x04+i, IMX355_EEPROM_SLAVE_ADDRESS);
       gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][i+48] = 0xFF;
    }

    /*Read QR Code from eeprom: 8~27*/
    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
       gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][8+i] = Eeprom_1ByteDataRead(0xB0+i, IMX355_EEPROM_SLAVE_ADDRESS);
    }
    ...
    memcpy(&gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][40], &vcmID, 4);
    memcpy(&gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][44], &lensID, 4);
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_MAIN2][39] = 2;
    /*Read stereo eeprom data*/
    for (i = 0; i < CALI_DATA_SLAVE_LENGTH; i ++) {
        gImgEepromInfo_21015.stereoMWdata[CALI_DATA_MASTER_LENGTH+i] =
                    Eeprom_1ByteDataRead(IMX355_STEREO_START_ADDR+i, IMX355_EEPROM_SLAVE_ADDRESS);
    }
    gImgEepromInfo_21015.i4CurSensorIdx = IMGSENSOR_SENSOR_IDX_MAIN2;
