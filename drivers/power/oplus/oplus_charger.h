...
/*	struct battery_data battery_main	*/
	...
	int wls_status_keep;
	int balancing_bat_stop_chg;            /*BSP.CHG.Basic, 2021/04/22, Add for Parallel charger, balance two battery voltage */
	int balancing_bat_stop_fastchg;        /*BSP.CHG.Basic, 2021/04/22, Add for Parallel charger, balance two battery voltage*/
