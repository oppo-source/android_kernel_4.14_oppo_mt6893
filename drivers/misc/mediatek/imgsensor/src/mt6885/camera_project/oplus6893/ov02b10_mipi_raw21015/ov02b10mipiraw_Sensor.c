...
static void read_module_data(void)
{
    ...
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][0] = Eeprom_1ByteDataRead(0x00, OV02B10_EEPROM_SLAVE_ADDRESS);
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][1] = Eeprom_1ByteDataRead(0x01, OV02B10_EEPROM_SLAVE_ADDRESS);
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][48] = 0xFF;
    gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][49] = 0xFF;
    imgsensor_info.module_id = Eeprom_1ByteDataRead(0x00, OV02B10_EEPROM_SLAVE_ADDRESS);
    Oplusimgsensor_Registdeviceinfo(gImgEepromInfo_21015.pCamModuleInfo[IMGSENSOR_SENSOR_IDX_SUB2].name,
                                    gImgEepromInfo_21015.pCamModuleInfo[IMGSENSOR_SENSOR_IDX_SUB2].version,
                                    imgsensor_info.module_id);
    /*Read SensorId LensId and VCMId: 2~7*/
    for(i = 2; i < 8; i++) {
       gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][i] = Eeprom_1ByteDataRead(0x03+i, OV02B10_EEPROM_SLAVE_ADDRESS);
       gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][i+48] = 0xFF;
    }
    /*Read QR Code from eeprom: 8~27*/
    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
       gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][8+i] = Eeprom_1ByteDataRead(0xE0+i, OV02B10_EEPROM_SLAVE_ADDRESS);
    }
    vcmID = Eeprom_1ByteDataRead(0x7, OV02B10_EEPROM_SLAVE_ADDRESS);
    lensID = Eeprom_1ByteDataRead(0x6, OV02B10_EEPROM_SLAVE_ADDRESS);
    memcpy(&gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][40], &vcmID, 4);
    memcpy(&gImgEepromInfo_21015.camNormdata[IMGSENSOR_SENSOR_IDX_SUB2][44], &lensID, 4);
    gImgEepromInfo_21015.i4CurSensorIdx = IMGSENSOR_SENSOR_IDX_SUB2;
